...
if __name__=="__main__":
    ...
    for batch_idx, batch in pbar:
        ...
        vae_loss = recon_loss + kl_loss*1e-5 - loss_disc*1e-1
        ...
        pbar.set_postfix_str(f"Batch {batch_idx}: recon loss: {recon_loss.item():.4f}, KL loss: {kl_loss.item():.2f}, Disc Loss: {loss_disc.item():.4f}")
